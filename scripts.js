...
if(newsContainer){
    fetch("https://newsapi.org/v1/articles?source=bbc-news&apiKey=e3ad53a0de4b4f7dbb3c2e564302cc15")
        .then(response => {
            return response.json();
        }).then(news => {
...
if(askJack){
    const askJackFormSubmit = e => {
        ...
        fetch("https://m003357c.github.io/DFM/first.html", {mode: "no-cors", method: "POST", body: contact})
            .then(response => {
